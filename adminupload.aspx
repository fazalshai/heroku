<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminupload.aspx.cs" Inherits="mentor.adminupload" %>
...
&nbsp;
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" Height="173px" Width="969px" HorizontalAlign="Center" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="lev" HeaderText="Level" SortExpression="lev" >
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="pre" HeaderText="Prerequisites" SortExpression="pre" >
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="PPT (or)Image">
                         <ItemTemplate>
